...
#Author of the SerialFlash base class: Emmanuel Blot <emmanuel.blot@free.fr>

class Numonyx_FlashDevice(SerialFlash):
	...
	NUM_SECTORS			=	(1 << 0x17) / SECTOR_SIZE	
	...
	def __init__(self, spiport, jedec):
		self._spi = spiport;
